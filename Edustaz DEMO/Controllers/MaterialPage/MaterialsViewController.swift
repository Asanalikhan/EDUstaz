...
class MaterialsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private lazy var filterStackView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [directionButton, classButton, subjectButton])
    ...
    private lazy var subjectButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont.systemFont(ofSize: 14, weight: .medium)
        button.backgroundColor = .white
        button.menu = createMenu(title: "Пән", options: ["Математика", "Физика", "Химия"]) { selected in
    ...
    let materials: [Material] = [Material(title: "Lorem Ipsum is simply dummy text of the", type: "Презентация", grade: 1, subject: "Математика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Ашық сабақ", grade: 1, subject: "Математика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Презентация", grade: 3, subject: "Физика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Ашық сабақ", grade: 3, subject: "Физика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Презентация", grade: 5, subject: "Физика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Ашық сабақ", grade: 6, subject: "Математика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Презентация", grade: 7, subject: "Математика"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Ашық сабақ", grade: 8, subject: "Химия"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Презентация", grade: 8, subject: "Химия"),
                                 Material(title: "Lorem Ipsum is simply dummy text of the", type: "Ашық сабақ", grade: 10, subject: "Химия")]
    ...
    private func updateMenus() {
        directionButton.menu = createMenu(title: "Бағыт", options: ["Презентация", "Ашық сабақ"]) { selected in
            self.selectedDirection = selected
        ...
        subjectButton.menu = createMenu(title: "Пән", options: ["Математика", "Физика", "Химия"]) { selected in
            self.selectedSubject = selected
            self.filterMaterials()
        }
    }
