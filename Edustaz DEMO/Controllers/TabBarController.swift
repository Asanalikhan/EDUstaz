...
//        let materialsVC = MaterialsViewController()
//        let certificateVC = CerticateViewController()
//        let courseVC = CourseViewController()
//        let olympiadVC = OlympiadViewController()
    ...
    func setupTabBarAppearance() {
       ...
       appearance.backgroundColor = UIColor.white // Change this to your desired color
