...
class OlympiadView: UIView {
    ...
    private lazy var titLabel: UILabel = {
        ...
        label.text = "Менің тіркелген олимпиадаларым"
        return label
    }()
    ...
    private lazy var pendingLabel: UILabel = {
        ...
        label.textAlignment = .center
        label.numberOfLines = 1
        label.text = "Сіз ешқандай олимпиадаларға тіркелмегенсіз"
        return label
    }()
    ...
    private lazy var button: UIButton = {
        ...
        button.addTarget(self, action: #selector(goToOlympiad), for: .touchUpInside)
        return button
    }()
...
private extension OlympiadView {
    func setupUI() {
        setupViews()
        setupConstraints()
    }
