...
class HomeViewController: BaseViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private lazy var countdownTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Маусым айының зияткерлік олимпиядасы"
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Басты Бет"
    ...
    func setupTabViews() {
        ...
        let tapButton1 = UITapGestureRecognizer(target: self, action: #selector(goToCertificateTab))
        ...
        let tapButton2 = UITapGestureRecognizer(target: self, action: #selector(goToCourseTab))
        button2.addGestureRecognizer(tapButton2)
        button2.isUserInteractionEnabled = true
        
        let button3 = TabView()
        button3.configure(with: UIImage(named: "material"), title: "Материалдар")
        let tapButton3 = UITapGestureRecognizer(target: self, action: #selector(goToMaterialTab))
        ...
        let tapButton4 = UITapGestureRecognizer(target: self, action: #selector(goToOlympiadTab))
    ...
    @objc func goToCertificateTab(){
        tabBarController?.selectedIndex = 2
    }
    
    @objc func goToMaterialTab(){
        tabBarController?.selectedIndex = 1
    }
    
    @objc func goToCourseTab(){
        tabBarController?.selectedIndex = 3
    }
    
    @objc func goToOlympiadTab(){
